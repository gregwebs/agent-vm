...
# plus the six shipped tool layers, chained in declaration order). A launch
...
# The six shipped tool layers, in declaration order — matching
...
INTERMEDIATE_LAYERS=(dsh pi codex opencode claude)
FINAL_LAYER=copilot
