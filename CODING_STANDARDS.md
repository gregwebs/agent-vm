<!-- Generated by scripts/install-standards.sh from skills-sdlc standards/: docs.md rust.md bash.md coding.md security.md
     Regenerate: ./scripts/install-standards.sh docs rust bash coding security -->
